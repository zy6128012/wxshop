...
import com.wx.comClass.WXPayClient;
...
public class WXPayH5PayController {
    ...
    public Object h5pay() throws Exception {
        ...
        reqData.put("notify_url", "http://wxshop.windtp.cn/wxpay/h5pay/notify");
        ...
        reqData.put("scene_info", "{\"h5_info\": {\"type\":\"Wap\",\"wap_url\": \"http://wxshop.windtp.cn\",\"wap_name\": \"腾讯充值\"}}");
